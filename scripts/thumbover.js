function thumbOver(which) {
	...
	if (filename == escape("tn_127.png")) imgname = "Zelfportret � la Goya";
	...
	//204.jpg -> weg	
	if (filename == escape("tn_206.jpg")) imgname = "Drie grati�n";
	...
	if (filename == escape("tn_309.jpg")) imgname = "Tweelingen / Twee�n";
	...
	if (filename == escape("tn_schilderijen 03 darius 118.jpg")) imgname = "Groen Caf�";
	...
	if (filename == escape("tn_262 b.jpg")) imgname = "Model �tude";
	if (filename == escape("tn_262.jpg")) imgname = "Model �tude II";
	...
	if (filename == escape("tn_schilderijen 01 036.jpg")) imgname = "Slapende vrouw met moza�kdekbed";
	...
	if (filename == escape("tn_schilderijen 03 darius 014.jpg")) imgname = "Model �tude";	
	...
	if (filename == escape("tn_schilderijen 03 darius 181.jpg")) imgname = "H�lya";
	...
	if (filename == escape("tn_schilderijen 04 en schilderijen amsterdam 046.jpg")) imgname = "De grote �talage";
	if (filename == escape("tn_schilderijen 04 en schilderijen amsterdam 047.jpg")) imgname = "Drie grati�n";
	...
	if (filename == escape("tn_schilderijen 03 darius 143.jpg")) imgname = "Archa�sche figuur";
	...
	if (filename == escape("tn_schilderijen 04 en schilderijen amsterdam 034.jpg")) imgname = "Paard als nacht naar antieke ru�ne toe";
