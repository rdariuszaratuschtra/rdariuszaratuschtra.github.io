function thumbOver(which) {
	...
	if (filename == escape("tn_schilderijen 01 004.png")) imgname = "Poort / Moeder of Vrouw";
	...
	if (filename == escape("tn_167.jpg")) imgname = "Paard / Vrouw / Business (compositie)";
	...
	if (filename == escape("tn_274.jpg")) imgname = "Struikelend paard";
